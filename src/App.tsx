...
export default function BottomAppBar () {
    ...
    reader.onload = (readerEvent) => {
      ...
      try {
        loader.parse(contents, '', (gltf: any) => {
          ...
          if (state.linkToSceneObject != null) state.linkToSceneObject.add(gltf.scene)
          setOpen(false)
        })
      } catch (error) {
  ...
  const loadOBJ = (file: File) => {
    ...
    reader.onload = (readerEvent) => {
      ...
      if (state.linkToSceneObject != null) state.linkToSceneObject.add(data)
      setOpen(false)
    }
  }
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >
        <Canvas
          getScene={(state.linkToSceneObject == null) ? getLinkScene : null}
          fullscreen
          enableShadows
        >
          <Camera
